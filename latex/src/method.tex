...
where \ac{doh} is not used. Instead the query is resolved by the exit relay. Our
...
of a destination for the exit relay to connect to (i.e., Tor uses
\texttt{RELAY\_RESOLVE} cells~\cite{TorSpecResolve}, see
...
python script is instead used to receive and provide dig-compliant DNS queries
and their answers. While negligible in this context, it should be noted that
some overhead is incurred in the process.
