...
\ac{dns} query performance by carefully tuning Tor circuit configurations,
...
be assured in the presence of colluding adversaries under a stronger threat
model.
...
\ac{odns}/\ac{odoh}, which can offer lower latency and are easier to deploy in
...
Our experiments primarily measured \ac{dns} query latency in a controlled
environment using NXDOMAIN lookups. This approach removes caching as a variable
but does not fully reflect real-world usage where cache hits are common.
