...
model. \todo{rewrite, clarify Tor threat model before this point}

\todo{Paragraph about the pros and cons of DoTor}
...
\ac{dohot} still inherits limitations from Tor, including potential
...
We argue that the middle relay in Tor's conventional three-hop design may not
be necessary for anonymous \ac{dns} resolution within the bounds of a
non-colluding adversary model. However, omitting it reduces the diversity of
the path and may weaken anonymity in settings with more powerful or coordinated
adversaries.
